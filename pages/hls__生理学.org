...
:END:
:①动、静脉血液之间po?差远大于PC。?差，所以当发生动・静脉短路时,动脉血PO?下降的程度大于PCO?升高的程度;②CO?的扩散系数约为。2的20倍，所以CO2扩散比。2快，不易潴留;③动脉血PO2下降和PC。?升高时，可刺激呼吸，增加肺泡通气量,有助于CO?的排出,却几乎无助于Q的摄取，这是由。2解离曲线和CO?解离曲线的特点所决定的（见本章第三节）。在肺气肿患者，由于许多细支气管阻塞和肺泡壁的破坏，vQ增大或减能*材典■普气效率受到极大影响,受此.V,/"可作为衡址肺换气功能的指标