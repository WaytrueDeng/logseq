...
:END:
**
* 颈动脉蛊压力感受器的传入神经纤维组成窦神经(carotidsinusnerve).加I入舌咽神经后湃入茹船-主动脉弓压力感等黑的传入神经纤维行击于迷击神经干内并隘力号金嬲｛(参母的主动昧弓压力感辱器传入纤维在颈部单独成为一束.与迷击神经伴行.称为主云册艇甥rticnerve)或降压神经(depressornerve)
:PROPERTIES:
:ls-type: annotation
:hl-page: 129
